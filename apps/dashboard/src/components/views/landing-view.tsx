    ...
    <div className="relative min-h-screen overflow-hidden cadia-bg scanlines">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-8 py-4 sm:py-5">
        ...
        >
          ...
          <span className="font-pixel text-base text-cadia text-glow-cadia tracking-wider">
            CADIA
          </span>
        </button>
        <motion.div
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 pt-10 pb-14 sm:pt-14 sm:pb-20 text-center max-w-3xl mx-auto">
        ...
        >
          <span className="font-pixel text-cadia text-glow-cadia text-3xl sm:text-5xl md:text-6xl block mb-2">
            CADIA
          </span>
          ...
          {FEATURES.map((f, i) => (
            <motion.div
              ...
              style={{
                background:
                  hoveredCard === i
                    ? `linear-gradient(135deg, ${f.color}18, rgba(17,22,29,0.6))`
                    : "rgba(17,22,29,0.5)",
                borderColor:
                  hoveredCard === i ? `${f.color}80` : "rgba(255,255,255,0.08)",
                boxShadow:
                  hoveredCard === i
                    ? `0 0 0 1px ${f.color}40, 0 8px 32px -8px ${f.color}60, 0 0 24px -4px ${f.color}50`
                    : "none",
                transform:
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3
                    className="font-pixel text-[11px] mb-3 tracking-wide"
                    style={{ color: f.color }}
                  >
                    {f.title.toUpperCase()}
                  </h3>
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(101,184,218,0.08), rgba(17,22,29,0.6))",
            boxShadow: "0 0 24px -8px rgba(101,184,218,0.3)",
          }}
        >
          <div className="mb-1">
            <h3 className="font-pixel text-sm text-cadia text-glow-cadia tracking-wider mb-1">
              CADIA LIVE STATS
            </h3>
