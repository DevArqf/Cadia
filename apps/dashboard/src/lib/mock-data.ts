...
export const MOCK_SERVERS: DiscordServer[] = [
  ...
  },
  {
    ...
    premium: false,
    roles: [
      role("t1", "@everyone", "#99aab5", 0, [], false),
      role("t2", "Admin", "#e94041", 5, ["ADMINISTRATOR"], false),
    ],
    region: "us-west",
...
// === Bot Modules with commands ===
export const DEFAULT_MODULES: BotModule[] = [
  {
    id: "mod-moderation",
    name: "Moderation",
    description: "Kick, ban, mute, warn — full moderator suite with case tracking.",
    category: "Moderation",
    enabled: true,
    response: "{target} has been {action} by {moderator}. Reason: {reason}",
    cooldown: 3,
    restrictedRoleIds: [],
    allowedRoleIds: [],
    icon: "",
    commands: [
      { id: "c-kick", name: "kick", description: "Kick a member", category: "Moderation", type: "Slash", enabled: true, cooldown: 3, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-ban", name: "ban", description: "Ban a member", category: "Moderation", type: "Slash", enabled: true, cooldown: 5, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-mute", name: "mute", description: "Timeout a member", category: "Moderation", type: "Slash", enabled: true, cooldown: 2, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-warn", name: "warn", description: "Warn a member", category: "Moderation", type: "Slash", enabled: true, cooldown: 1, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-purge", name: "purge", description: "Bulk delete messages", category: "Moderation", type: "Slash", enabled: false, cooldown: 8, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
    ],
  },
  {
    id: "mod-rpg",
    name: "RPG System",
    description: "Full RPG with classes, leveling, quests, and PvP. Level up by chatting and fighting.",
    category: "RPG",
    enabled: true,
    response: "⚔️ {user} used {skill} on {target} for {damage} damage!",
    cooldown: 5,
    restrictedRoleIds: [],
    allowedRoleIds: [],
    icon: "",
    commands: [
      { id: "c-fight", name: "fight", description: "Fight a target", category: "RPG", type: "Slash", enabled: true, cooldown: 5, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-quest", name: "quest", description: "Start a quest", category: "RPG", type: "Slash", enabled: true, cooldown: 30, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-class", name: "class", description: "Choose a class", category: "RPG", type: "Slash", enabled: true, cooldown: 0, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-inventory", name: "inventory", description: "View inventory", category: "RPG", type: "Slash", enabled: true, cooldown: 2, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-shop", name: "shop", description: "Open the shop", category: "RPG", type: "Context", enabled: false, cooldown: 0, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
    ],
  },
  {
    id: "mod-welcome",
    name: "Welcome & Goodbye",
    description: "Greet new members with a custom pixel-art message and farewell departing ones.",
    category: "Utility",
    enabled: true,
    response: "👋 Welcome {user} to {server}! You are member #{count}.",
    cooldown: 0,
    restrictedRoleIds: [],
    allowedRoleIds: [],
    icon: "",
    commands: [
      { id: "c-test-welcome", name: "test-welcome", description: "Preview welcome message", category: "Utility", type: "Slash", enabled: true, cooldown: 10, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
    ],
  },
  {
    id: "mod-logging",
    name: "Logging",
    description: "Log every moderation action, message edit, member join/leave, and more.",
    category: "Logging",
    enabled: true,
    response: "📝 {actor} performed {action} on {target}.",
    cooldown: 0,
    restrictedRoleIds: [],
    allowedRoleIds: [],
    icon: "",
    commands: [
      { id: "c-logs", name: "logs", description: "View recent logs", category: "Logging", type: "Slash", enabled: true, cooldown: 5, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-log-config", name: "log-config", description: "Configure log channels", category: "Logging", type: "Slash", enabled: true, cooldown: 0, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
    ],
  },
  {
		id: "mod-suggestions",
    ...
    icon: "",
    commands: [
      { id: "c-8ball", name: "8ball", description: "Ask the magic 8ball", category: "Fun", type: "Slash", enabled: true, cooldown: 2, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-dice", name: "dice", description: "Roll a die", category: "Fun", type: "Slash", enabled: true, cooldown: 1, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-meme", name: "meme", description: "Random meme", category: "Fun", type: "Slash", enabled: true, cooldown: 5, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
      { id: "c-trivia", name: "trivia", description: "Trivia question", category: "Fun", type: "Slash", enabled: false, cooldown: 10, restrictedRoleIds: [], allowedRoleIds: [], allowedChannelIds: [], ignoredChannelIds: [], ignoredRoleIds: [] },
    ],
  },
];
