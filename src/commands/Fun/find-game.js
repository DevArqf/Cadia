...
class UserCommand extends CadiaCommand {
	...
	async chatInputRun(interaction) {
        ...
        if (Category === "Rythm") {
            ...
            .addFields(
                { name: `Game:`, value: `${Rythm[choices]}`, inline: true },
                { name: `Category:`, value: `${Category}`, inline: true },
                { name: `Requested by:`, value: `<@${interaction.user.id}>`, inline: true }
            )
            .setFooter({ text: `Random Rythm Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "FPS") {
            ...
            .setFooter({ text: `Random FPS Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Arcade") {
            ...
            .setColor(color.default)
            .addFields(
                { name: `Game:`, value: `${Arcade[choices]}`, inline: true },
                { name: `Category:`, value: `${Category}`, inline: true },
                { name: `Requested by:`, value: `<@${interaction.user.id}>`, inline: true }
            )
            .setFooter({ text: `Random Arcade Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Shooter") {
            ...
            .setFooter({ text: `Random Shooter Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Military") {
            ...
            .setFooter({ text: `Random Military Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Action") {
            ...
            .setFooter({ text: `Random Action Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Racing") {
            ...
            .setColor(color.default)
            .addFields(
                { name: `Game:`, value: `${Racing[choices]}`, inline: true },
                { name: `Category:`, value: `${Category}`, inline: true },
                { name: `Requested by:`, value: `<@${interaction.user.id}>`, inline: true }
            )
            .setFooter({ text: `Random Racing Game Found`, iconURL: interaction.user.displayAvatarURL() })
        ...
        if (Category === "Adventure") {
            ...
            .setFooter({ text: `Random Adventure Game Found`, iconURL: interaction.user.displayAvatarURL() })
