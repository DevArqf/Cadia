...
const standaloneAppRoot = path.join(standaloneRoot, 'apps', 'dashboard');
...
copyDirectory(path.join(dashboardRoot, '.next', 'static'), path.join(standaloneAppRoot, '.next', 'static'));
copyDirectory(path.join(dashboardRoot, 'public'), path.join(standaloneAppRoot, 'public'));
